...
🚀 How to Run
Open 01_etl_pipeline.ipynb in Jupyter Notebook, add your MySQL password, and run the cells to upload the data into your MySQL server.
Open 02_analytics_queries.sql in MySQL Workbench to run the SQL calculations.
Open olist_dashboard.pbix in Power BI Desktop to view or interact with the dashboard.
